...
public extension Asyncify { //AATask functions
    ...
    @discardableResult public static func merge<A, B>(_ a: AATask<A>,
                                                      _ b: AATask<B>,
    ...
    @discardableResult public static func merge<A, B, C>(_ a: AATask<A>,
                                                         _ b: AATask<B>,
                                                         _ c: AATask<C>,
                                                         observeOn: DispatchQueue = DispatchQueue.main,
    ...
    @discardableResult public static func merge<A, B, C, D>(_ a: AATask<A>,
                                                            _ b: AATask<B>,
                                                            _ c: AATask<C>,
                                                            _ d: AATask<D>,
                                                            observeOn: DispatchQueue = DispatchQueue.main,
    ...
    @discardableResult public static func merge<A, B, C, D, E>(_ a: AATask<A>,
                                                               _ b: AATask<B>,
                                                               _ c: AATask<C>,
                                                               _ d: AATask<D>,
                                                               _ e: AATask<E>,
...
public extension Asyncify { //AATaskVoid functions
    ...
    public static func merge<A, B>(_ a: AATaskVoid<A>,
                                   _ b: AATaskVoid<B>,
                                   observeOn: DispatchQueue = DispatchQueue.main,
    ...
    public static func merge<A, B, C>(_ a: AATaskVoid<A>,
                                      _ b: AATaskVoid<B>,
                                      _ c: AATaskVoid<C>,
                                      observeOn: DispatchQueue = DispatchQueue.main,
    ...
    public static func merge<A, B, C, D>(_ a: AATaskVoid<A>,
                                         _ b: AATaskVoid<B>,
                                         _ c: AATaskVoid<C>,
                                         _ d: AATaskVoid<D>,
                                         observeOn: DispatchQueue = DispatchQueue.main,
    ...
    public static func merge<A, B, C, D, E>(_ a: AATaskVoid<A>,
                                            _ b: AATaskVoid<B>,
                                            _ c: AATaskVoid<C>,
                                            _ d: AATaskVoid<D>,
                                            _ e: AATaskVoid<E>,
