...
class AsyncZipTests: XCTestCase {
    ...
    func test_zip_1() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_str, completion: { value, error in
    ...
    func test_zip_2() {
        ...
        Asyncify.zip(AsyncMockZips.zip_5_str, completion: { value, error in
    ...
    func test_zip_3() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_int, AsyncMockZips.zip_2_str, completion: { value, error in
    ...
    func test_zip_4() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_int, AsyncMockZips.zip_2_str, AsyncMockZips.zip_3_bool, completion: { value, error in
    ...
    func test_zip_5() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_int, AsyncMockZips.zip_2_str, AsyncMockZips.zip_3_bool, AsyncMockZips.zip_3_strArr, completion: { value, error in
    ...
    func test_zip_6() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_int, AsyncMockZips.zip_2_str, AsyncMockZips.zip_3_bool, AsyncMockZips.zip_3_strArr, AsyncMockZips.zip_2_intArr,
    ...
    func test_zip_7() {
        ...
        Asyncify.zip(AsyncMockZips.zip_3_int, AsyncMockZips.zip_4_str, AsyncMockZips.zip_3_bool, AsyncMockZips.zip_4_strArr,
