...
extension AsyncAlly {
    ...
    static func zip<A>(_ tasks: [AATaskObject<A>],
    ...
    static func zip<A, B>(_ a: [AATaskObject<A>],
                          _ b: [AATaskObject<B>],
                          observeOn: DispatchQueue = DispatchQueue.main,
    ...
    static func zip<A, B, C>(_ a: [AATaskObject<A>],
                             _ b: [AATaskObject<B>],
                             _ c: [AATaskObject<C>],
                             observeOn: DispatchQueue = DispatchQueue.main,
    ...
    static func zip<A, B, C, D>(_ a: [AATaskObject<A>],
                                _ b: [AATaskObject<B>],
                                _ c: [AATaskObject<C>],
                                _ d: [AATaskObject<D>],
                                observeOn: DispatchQueue = DispatchQueue.main,
    ...
    static func zip<A, B, C, D, E>(_ a: [AATaskObject<A>],
                                   _ b: [AATaskObject<B>],
                                   _ c: [AATaskObject<C>],
                                   _ d: [AATaskObject<D>],
                                   _ e: [AATaskObject<E>],
